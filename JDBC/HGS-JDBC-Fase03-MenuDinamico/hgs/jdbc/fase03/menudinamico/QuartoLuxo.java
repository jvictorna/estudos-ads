...
public class QuartoLuxo extends Quarto {
    ...
    public QuartoLuxo(int numero, int andar, String tipo, String modelo, String tamanho, boolean hdr) {
        super(numero, andar, tipo, modelo, tamanho);
        this.hidromassagem = hdr;
    }

    @Override
    public boolean executarCheckListPosCheckout(Scanner teclado) {
            String cama, toalha, banheiro, enxoval, lixo, arCondicionado, televisao, frigobar, banheira, testeHidromassagem;
    ...
    public boolean executarCheckListArrumacao(Scanner teclado) {
        String cama, enxoval, toalha, banheiro, lixo, arCondicionado, televisao, frigobar, banheira, testeHidromassagem;
    ...
    public boolean executarCheckListRevisaoGeral(Scanner teclado) {
        String cama, banheiro, cortina, lampada, arCondicionado, televisao, frigobar, banheira, testeHidromassagem;
